...
SRC_URI="https://github.com/libretro/common-shaders/archive/7b403c8fffb8b571cd76a061e4754ee57e7d5ecd.tar.gz -> ${P}.tar.gz"
RESTRICT="primaryuri"

S="${WORKDIR}/common-shaders-7b403c8fffb8b571cd76a061e4754ee57e7d5ecd"

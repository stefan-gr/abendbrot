...
SRC_URI="https://github.com/libretro/common-shaders/archive/4de0b53ecf37d94f6a4e5347e8afd39a539c1d1d.tar.gz -> ${P}.tar.gz"
RESTRICT="primaryuri"

S="${WORKDIR}/common-shaders-4de0b53ecf37d94f6a4e5347e8afd39a539c1d1d"

...
SRC_URI="https://github.com/libretro/beetle-pce-fast-libretro/archive/191715368595860d0d331180f919a8f14dfb30d1.tar.gz -> ${P}.tar.gz"
RESTRICT="primaryuri"

S="${WORKDIR}/beetle-pce-fast-libretro-191715368595860d0d331180f919a8f14dfb30d1"

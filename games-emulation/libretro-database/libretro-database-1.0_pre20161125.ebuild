...
SRC_URI="https://github.com/libretro/libretro-database/archive/6de305c6079896553777759a3a0493ba98a7e001.tar.gz -> ${P}.tar.gz"
RESTRICT="primaryuri"

S="${WORKDIR}/libretro-database-6de305c6079896553777759a3a0493ba98a7e001"

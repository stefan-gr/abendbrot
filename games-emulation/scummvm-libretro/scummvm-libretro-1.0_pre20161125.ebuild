...
SRC_URI="https://github.com/libretro/scummvm/archive/cad7e633be838a0d211665e11befacbe8703723f.tar.gz -> ${P}.tar.gz"
RESTRICT="primaryuri"

S="${WORKDIR}/scummvm-cad7e633be838a0d211665e11befacbe8703723f"

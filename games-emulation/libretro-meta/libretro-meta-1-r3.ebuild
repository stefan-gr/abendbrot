...
LICENSE="metapackage"
SLOT="0"
IUSE="+2048 +4do +beetle-psx bnes +bsnes bsnes-cpp98 craft +desmume dolphin +fbalpha fbalpha2012 fceumm +gambatte +genplus glupen64 \
...
RDEPEND="2048? ( >=games-emulation/2048-libretro-1.0_pre20170119 )
		...
		bsnes-cpp98? ( >=games-emulation/bsnes-libretro-cplusplus98-1.0_pre20170124 )
		...
		fceumm? ( || ( >=games-emulation/fceumm-libretro-1.0_pre20170127 games-emulation/fceu-next-libretro ) )
		gambatte? ( >=games-emulation/gambatte-libretro-1.0_pre20170203 )
		genplus? ( >=games-emulation/genplus-libretro-1.0_pre20170124 )
		glupen64? ( >=games-emulation/glupen64-libretro-1.0_pre20170130 )
		handy? ( >=games-emulation/handy-libretro-1.0_pre20170124 )
		mame2000? ( >=games-emulation/mame2000-libretro-1.0_pre20170127 )
		mame? ( >=games-emulation/mame-libretro-1.0_pre20170125 )
		...
		mgba? ( || ( >=games-emulation/mgba-libretro-1.0_pre20170131 >=games-emulation/mgba-libretro-cheevo-1.0_pre20170131 ) )
		mupen64plus? ( >=games-emulation/mupen64plus-libretro-1.0_pre20170131 )
		nestopia? ( >=games-emulation/nestopia-libretro-1.0_pre20170128 )
		...
		reicast? ( >=games-emulation/reicast-libretro-1.0_pre20170126 )
		scummvm? ( >=games-emulation/scummvm-libretro-1.0_pre20170124 )
		snes9x2002? ( >=games-emulation/snes9x2002-libretro-1.0_pre20170128 )
		snes9x2010? ( >=games-emulation/snes9x2010-libretro-1.0_pre20170125 )
		snes9x? ( >=games-emulation/snes9x-libretro-1.0_pre20170126 )

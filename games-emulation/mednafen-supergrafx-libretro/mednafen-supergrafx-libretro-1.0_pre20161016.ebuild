...
SRC_URI="https://github.com/libretro/beetle-supergrafx-libretro/archive/e958bd5b829111d427d1a0ada02b7ed897ef9d33.tar.gz -> ${P}.tar.gz"
RESTRICT="primaryuri"

S="${WORKDIR}/beetle-supergrafx-libretro-e958bd5b829111d427d1a0ada02b7ed897ef9d33"

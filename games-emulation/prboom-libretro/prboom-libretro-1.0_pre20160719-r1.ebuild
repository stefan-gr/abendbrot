...
SRC_URI="https://github.com/libretro/libretro-prboom/archive/448fa6e3ff6a6c07ed9ff19da45bea7e28bf12b3.tar.gz -> ${P}.tar.gz"
RESTRICT="primaryuri"

S="${WORKDIR}/libretro-prboom-448fa6e3ff6a6c07ed9ff19da45bea7e28bf12b3"

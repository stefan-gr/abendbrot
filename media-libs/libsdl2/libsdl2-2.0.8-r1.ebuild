...
IUSE="cpu_flags_x86_3dnow alsa altivec aqua custom-cflags dbus gles haptic libsamplerate +joystick cpu_flags_x86_mmx nas opengl oss pulseaudio +sound cpu_flags_x86_sse cpu_flags_x86_sse2 static-libs +threads tslib udev +video wayland X xinerama xscreensaver kms videocore"
REQUIRED_USE="
	alsa? ( sound )
	gles? ( video )
	nas? ( sound )
...
multilib_src_configure() {
	...
	local myeconfargs=(
		...
		$(use_enable videocore video-rpi)
	)
